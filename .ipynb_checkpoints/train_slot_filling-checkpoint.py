...
parser.add_argument('--cls_vocab_size',
                    default=100, type=int,
                    action='store',)
...
parser.add_argument('--ratio_supervised',
                    default=1., type=float,
                    action='store',)

parser.add_argument('--ratio_weak_supervised',
                    default=1., type=float,
                    action='store',)

parser.add_argument('--weak_prefix',
                    default='weak', type=str,
                    action='store',)
...
trainer = Trainer(
    ...
    train_weak_path=f'./datasets/unified/train.{args.weak_prefix}.{flag}.json',
    ...
    ratios={
        'supervised': args.ratio_supervised,
        'weak_supervised': args.ratio_weak_supervised,
    },
)
